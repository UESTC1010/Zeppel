    ...
    with torch.no_grad():
        for data in tqdm(eval_dataloader):
            ...
            if not eval_data_path:
                ...
                out_list = [output_str[i] for i in range(len(output_str))]
                hypoth = []
...
def predict(
    ...
    return [output_str[i] for i in range(len(output_str))]
...
if __name__ == "__main__":
    ...
    parse.add_argument("-out_path", default="en.txt", type=str)
