...
def get_model(args):
    if args.model_path:
        ...
        decoder = BertGenerationDecoder.from_pretrained(
            args.tgt_pretrain_dataset_name, is_decoder=True,add_cross_attention=True
        )
        ...
        # model = EncoderDecoderModel.from_encoder_decoder_pretrained(args.src_pretrain_dataset_name, args.tgt_pretrain_dataset_name)
