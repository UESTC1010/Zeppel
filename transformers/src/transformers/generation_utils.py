...
class GenerationMixin:
    ...
    def _get_logits_processor(
        ...
        if encoder_no_repeat_ngram_size is not None and encoder_no_repeat_ngram_size > 0:
            if self.config.is_encoder_decoder:
                processors.append(EncoderNoRepeatNGramLogitsProcessor(encoder_no_repeat_ngram_size, encoder_input_ids,diversity_penalty=diversity_penalty))
            else:
                raise ValueError(
    ...
    def generate(
        ...
        inputs_for_dbs: Optional[torch.LongTensor] = None,
        ...
        **model_kwargs,
        ...
        if encoder_no_repeat_ngram_size:
            encoder_input_ids = inputs_for_dbs if self.config.is_encoder_decoder else None
        else:
            encoder_input_ids = input_ids if self.config.is_encoder_decoder else None
